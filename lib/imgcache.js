...
var ImgCache = {
  ...
  options: {
    ...
    overridesHelpers: null                  /* list of functions to override Helpers' */
  },
  overridables: {
    hash: function (s) {
...
(function ($) {
  ...
  Helpers.isCordova = function () {
    if (ImgCache.options.overridesHelpers && ImgCache.options.overridesHelpers.isCordova) {
      return ImgCache.options.overridesHelpers.isCordova();
    }
  ...
  Helpers.isCordovaAndroid = function () {
    if (ImgCache.options.overridesHelpers && ImgCache.options.overridesHelpers.isCordovaAndroid) {
      return ImgCache.options.overridesHelpers.isCordovaAndroid();
    }
  ...
  Helpers.isCordovaWindowsPhone = function () {
    if (ImgCache.options.overridesHelpers && ImgCache.options.overridesHelpers.isCordovaWindowsPhone) {
      return ImgCache.options.overridesHelpers.isCordovaWindowsPhone();
    }
  ...
  Helpers.isCordovaIOS = function () {
    if (ImgCache.options.overridesHelpers && ImgCache.options.overridesHelpers.isCordovaIOS) {
      return ImgCache.options.overridesHelpers.isCordovaIOS();
    }
  ...
  Helpers.EntryGetPath = function (entry) {
    if (Helpers.isCordova()) {
      // #93
      if (Helpers.isCordovaIOS() || Helpers.isCordovaAndroid()) {
  ...
  ImgCache.cacheFile = function (img_src, callback) {
    ...
    fileTransfer.download(
      ...
      function (entry) {
        ...
        if (Helpers.isCordovaIOS() && entry.setMetadata) {
          entry.setMetadata(
            function () {
              /* success*/
              ImgCache.overridables.log('com.apple.MobileBackup metadata set', LOG_LEVEL_INFO);
  ...
  ImgCache.cacheBackground = function ($div, callback) {
    if (!Private.isImgCacheLoaded()) {
      return;
    }
    ...
    if (!img_src) {
      ...
      if (callback) {
        callback(false, 'No background to cache');
      }
      return;
    }

    ImgCache.overridables.log('Background image URL: ' + img_src, LOG_LEVEL_INFO);
    ImgCache.cacheFile(img_src, callback);
  };
